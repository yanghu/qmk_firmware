...
#define __________QWERTY_L2__________       NUM_CTRL, HOME_A,  HOME_S,  KC_D,    HOME_F,  KC_G
...
#define __________SYMBOL_R3__________       XXXXXXX, KC_PLUS, KC_LT,   KC_GT,   KC_QUES, _______
