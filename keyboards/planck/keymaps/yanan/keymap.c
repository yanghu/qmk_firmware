...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_wrapper(
      ...
      ENC_SWITCH,    KC_LGUI, KC_LALT, NUM_ALT, MO(_SYMBOL), NAV_ENT, SFT_SPACE,   KC_LEFT, KC_DOWN, KC_UP,   LT(_PSCR, KC_RGHT)),
  ...
  [_NUMPAD] = LAYOUT_wrapper(
      ...
      __________BLANK__________,  KC_P0, KC_DOT, XXXXXXX, XXXXXXX, KC_PENT),
